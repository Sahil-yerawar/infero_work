...
int main(){
    ...
    for(int i= 0;i<n-1;i++){
      ...
      cin >> x >> y;
      coords.pb(mp(x,y));
      result += (sqrt((coords[coords.size()-1].ff-coords[coords.size()-2].ff)*(coords[coords.size()-1].ff-coords[coords.size()-2].ff)+(coords[coords.size()-1].ss-coords[coords.size()-2].ss)*(coords[coords.size()-1].ss-coords[coords.size()-2].ss)))/50;
